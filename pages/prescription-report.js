...
function PrescriptionReport() {
  ...
  const [
    ...
    {
      loading: createPrescriptionDataLoading,
      data: createPrescriptionDataData,
      error: createPrescriptionDataError,
    },
  ] = useMutation(CREATE_PRESCRIPTION_DATA);
  ...
  if (userRole === "Digitize Prescription") {
    return (
      <>
        <Header />
